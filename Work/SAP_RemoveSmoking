...
if(window.location.href == "https://hr-selfservice.intra.men.de:44309/sap/bc/ui5_ui5/ui2/ushell/shells/abap/FioriLaunchpad.html#LeaveRequest-manage") {
    waitForKeyElements(".sapMLIB.sapMLIB-CTX.sapMLIBShowSeparator.sapMLIBTypeNavigation.sapMLIBActionable.sapMLIBHoverable.sapMLIBFocusable.sapMListTblRow", removeSmoking);
}
